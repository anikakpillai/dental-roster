...
A2. FULL-SPAN ASSISTANT COVERAGE: every dentist needs their required assistant count (see assistant_count_by_dentist; default 1) from their start to their end. If a dentist day is longer than one assistant may legally work (daily cap), STAGGER assistants: an early assistant starts with the dentist, a late assistant finishes with the dentist, overlapping at handover. Never leave the start or tail of a dentist day under-covered.
